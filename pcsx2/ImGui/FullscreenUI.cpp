...
void FullscreenUI::DrawEmulationSettingsPage()
{
	...
	DrawToggleSetting(bsi, FSUI_ICONSTR(ICON_FA_COMPACT_DISC, "Enable CDVD Precaching"), FSUI_CSTR("Loads the disc image into RAM before starting the virtual machine. Use with caution on UWP"),
...
void FullscreenUI::SetAchievementsLoginReason(Achievements::LoginRequestReason reason)
{
	s_achievements_login_reason = reason;
...
void FullscreenUI::DrawAchievementsLoginWindow()
{
	...
	if (ImGui::BeginPopupModal("RetroAchievements", &s_achievements_login_open, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoTitleBar))
	{
		...
		ImGui::TextWrapped("%s", FSUI_CSTR("Please enter your user name and password for retroachievements.org below. Your password will not be saved in XBSX2, an access token will be generated and used instead."));
		ImGui::PopStyleColor();
		ImGui::PopTextWrapPos();
...
TRANSLATE_NOOP("FullscreenUI", "VMManager");
...
TRANSLATE_NOOP("FullscreenUI", "Enter a new value:");
...
TRANSLATE_NOOP("FullscreenUI", "Loads the disc image into RAM before starting the virtual machine. Use with caution on UWP");
...
TRANSLATE_NOOP("FullscreenUI", "Unset");
TRANSLATE_NOOP("FullscreenUI", "PCAP Bridged");
TRANSLATE_NOOP("FullscreenUI", "PCAP Switched");
TRANSLATE_NOOP("FullscreenUI", "TAP");
TRANSLATE_NOOP("FullscreenUI", "Sockets");
...
TRANSLATE_NOOP("FullscreenUI", "PS2 IP Address");
